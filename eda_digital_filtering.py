...
def eda_digital_filter(eda_signal, sampling_rate, cut_off, order):
    """Takes an eda signal, the sampling rate, and a desired cut off-frequency returns the clean signal
    """
    # Handle missing data
